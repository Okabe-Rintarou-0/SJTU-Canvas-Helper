package com.sjtu.canvas.helper.di
...
object NetworkModule {
    ...
    private const val BASE_URL = "https://oc.sjtu.edu.cn/"
    ...
    @Provides
    @Singleton
    fun provideCanvasApi(retrofit: Retrofit): CanvasApi {
        return retrofit.create(CanvasApi::class.java)
    }
}
