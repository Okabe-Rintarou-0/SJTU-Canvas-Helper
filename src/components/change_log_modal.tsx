...
export function ChangeLogModal({ open, onCancel, onOk }: {
    ...
    return <Modal title="更新日志" open={open} width={"90%"} footer={null} onCancel={onCancel} onOk={onOk} style={{
        ...
        <Typography>
            <Title level={4}>v2.0.5 2025/12/6</Title>
            <Paragraph>
                <ul>
                    <li>修复 pdf 渲染</li>
                </ul>
            </Paragraph>
            <Title level={4}>v2.0.3 2025/10/18</Title>
            <Paragraph>
                <ul>
                    <li>修复字幕下载</li>
                    <li>支持外部文件</li>
            ...
            <Title level={4}>v2.0.2 2025/10/15</Title>
            <Paragraph>
                <ul>
                    <li>修复作业评分</li>
                </ul>
            </Paragraph>
            <Title level={4}>v2.0.1 2025/10/12</Title>
            <Paragraph>
                <ul>
                    <li>修复视频功能</li>
                </ul>
            </Paragraph>
            <Title level={4}>v2.0.0 2025/10/2</Title>
            <Paragraph>
                <ul>
                    <li>迁移至 Tauri v2</li>
                </ul>
            ...
            <Title level={4}>v1.3.31 2025/5/11</Title>
            <Paragraph>
                <ul>
                    <li>一些小补丁</li>
                </ul>
            </Paragraph>
            <Title level={4}>v1.3.30 2025/5/11</Title>
            <Paragraph>
                <ul>
                    <li>支持切换前端主题，见设置</li>
                </ul>
